    ...
    <div class="form-group extra" autocomplete="off"> <label for="id_password1" class="control-label  requiredField">
        ...
        <div class="controls ">
            <div class="input-group"> <input type="password" name="password1" maxlength="30"
                    ...
                    class="input-group-btn"><button class=" rounded-3 btn" id="go-button" type="button">Go!</button><button
                        class="btn extra" type="button">No!</button><button class=" rounded-3 btn" name="whatever" type="submit"
